export default function () {
  return `
    <div class="interactive-container" style="position: relative; max-width: 90%; margin: 0 auto;">
      <!-- Main Timeline Image -->
      <img 
      ...
      <!-- Argentina Info -->
      <h3 style="position: absolute; top: 31.5%; left: 56.5%; color: #57622E; font-size: 1rem;">ARGENTINA</h3>
      <p style="position: absolute; top: 37.5%; left: 59.5%; color: black; font-size: 0.5rem;">2,780,400 km<sup>2</sup></p>
      <p style="position: absolute; top: 44.5%; left: 59.5%; color: black; font-size: 0.5rem;">44,938,712</p>
      <p style="position: absolute; top: 51.5%; left: 59.5%; color: black; font-size: 0.5rem;">Buenos Aires</p>
    ...
    <!-- Instruction -->
    <p class="interactive-instruction" style="text-align: center; font-style: italic; margin-top: 1rem;">
      Click the leaves to reveal
    </p>

    <!-- CSS: Hide everything under 550px -->
    <style>
